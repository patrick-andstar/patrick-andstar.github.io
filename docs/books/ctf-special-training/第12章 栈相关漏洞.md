...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00044_img_in_image_box_171_192_1044_1372.webp){ width="71%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00047_img_in_image_box_148_315_1031_541.webp){ width="72%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00048_img_in_image_box_187_174_1040_946.webp){ width="69%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00052_img_in_image_box_150_139_954_719.webp){ width="65%" }

*图12-5 x86程序参数传递示意图*

x64反汇编代码如图12-6所示。

![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00052_img_in_image_box_148_901_976_1347.webp){ width="67%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00053_img_in_image_box_160_656_1061_1288.webp){ width="73%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00056_img_in_image_box_169_268_1057_638.webp){ width="72%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00057_img_in_image_box_153_706_1080_1271.webp){ width="75%" }

*图12-9 开启NX的程序内存布局*

proc的内存状态如图12-10所示。

![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00058_img_in_image_box_152_232_1080_795.webp){ width="75%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00059_img_in_image_box_204_171_1016_515.webp){ width="66%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00001_img_in_image_box_151_135_1043_834.webp){ width="72%" }

*图12-12 带有canary的程序反汇编实例*

proc的反汇编结果如图12-13所示。

![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00002_img_in_image_box_148_137_966_574.webp){ width="66%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00002_img_in_image_box_277_917_954_1163.webp){ width="55%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00004_img_in_image_box_148_133_1078_860.webp){ width="75%" }

*图12-15 测试样例的反汇编代码*

可以看到，target_func的地址为0x4005C6，栈buff的大小是0x10的大小，运行到gets函数调用处，内存状态如图12-16所示。

![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00005_img_in_image_box_153_142_1080_602.webp){ width="75%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00005_img_in_image_box_152_983_1080_1385.webp){ width="75%" }

*图12-17 执行到leave指令时的内存状态*

单步执行si，运行到ret指令，可以看到返回地址为DDDDDDDD，即0x4444

![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00006_img_in_image_box_152_438_1079_1033.webp){ width="75%" }

*图12-18 执行到ret指令时的内存状态*

将输入中的DDDDDDDD用target_func的地址0x4005C6来替代，就能执行到target_func，如图12-19所示。

![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00006_img_in_image_box_152_1287_1077_1350.webp){ width="75%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00007_img_in_image_box_322_860_896_1315.webp){ width="46%" }

*图12-20 函数调用时的栈布局*

![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00008_img_in_image_box_311_182_922_707.webp){ width="49%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00009_img_in_image_box_191_154_979_664.webp){ width="64%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00010_img_in_image_box_189_152_1051_853.webp){ width="70%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00011_img_in_image_box_369_872_851_985.webp){ width="39%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00012_img_in_image_box_181_646_1039_1153.webp){ width="70%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00013_img_in_image_box_173_553_948_634.webp){ width="63%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00016_img_in_image_box_184_539_1037_1360.webp){ width="69%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00019_img_in_image_box_292_183_962_1074.webp){ width="54%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00020_img_in_image_box_324_1222_897_1308.webp){ width="46%" }

*图12-29 线程栈地址*

用gdb attack程序查看内存布局，如图12-30所示。

![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00021_img_in_image_box_153_232_1079_1034.webp){ width="75%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00026_img_in_image_box_215_173_1035_1167.webp){ width="66%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00028_img_in_image_box_206_171_1057_1185.webp){ width="69%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00039_img_in_image_box_150_408_1080_542.webp){ width="75%" }

*图12-38 程序开启保护的检测情况*

该题的逻辑其实与下象棋差不多，布局如图12-39所示。

![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00039_img_in_image_box_430_736_791_1166.webp){ width="29%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00043_img_in_image_box_150_929_1073_1382.webp){ width="75%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00046_img_in_image_box_198_139_1023_720.webp){ width="67%" }
...
![图片](/books/ctf-special-training/assets/第12章 栈相关漏洞_page_00052_img_in_image_box_356_745_865_1053.webp){ width="41%" }
