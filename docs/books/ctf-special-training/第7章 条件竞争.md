...
<div style="text-align: center;">图7-1 多用户同时访问形成的条件竞争</div>

首先，我们利用前面介绍的Burp的Intruder模块进行测试，截取数据包之后进行配置，在Payloads一栏配置访问总次数为1000，如图7-2所示。

Payloads

![图片](/books/ctf-special-training/assets/chunk_00181_00240_page_00003_img_in_image_box_173_559_213_622.webp){ width="100%" }
...
![图片](/books/ctf-special-training/assets/chunk_00181_00240_page_00003_img_in_image_box_628_779_656_823.webp){ width="100%" }
...
![图片](/books/ctf-special-training/assets/chunk_00181_00240_page_00003_img_in_image_box_173_1032_213_1095.webp){ width="100%" }
...
![图片](/books/ctf-special-training/assets/chunk_00181_00240_page_00003_img_in_image_box_233_1255_259_1293.webp){ width="100%" }

Generate 1000

payloads

![图片](/books/ctf-special-training/assets/chunk_00181_00240_page_00003_img_in_image_box_233_1331_259_1372.webp){ width="100%" }

Continue indefinitely

<div style="text-align: center;">图7-2 设置访问数量为1000次</div>

然后，在Options一栏配置并发线程数为80（如图7-3所示），当然这个数目越大就越容易触发条件竞争，但是数目过大可能会对服务器造成一定负担。

![图片](/books/ctf-special-training/assets/chunk_00181_00240_page_00004_img_in_image_box_152_439_1080_1181.webp){ width="100%" }

<div style="text-align: center;">图7-3 设置线程数量为80</div>

我们期望最后结果的值应该是1000次，但是从实验结果可以发现，1000个访问请求最后只记录了786次，如图7-4所示。

![图片](/books/ctf-special-training/assets/chunk_00181_00240_page_00005_img_in_image_box_149_142_1081_1412.webp){ width="100%" }

<div style="text-align: center;">图7-4 Burp测试条件竞争的结果</div>
...
![图片](/books/ctf-special-training/assets/chunk_00181_00240_page_00007_img_in_image_box_153_290_1080_1058.webp){ width="100%" }

<div style="text-align: center;">图7-5 Python测试条件竞争的结果</div>
...
![图片](/books/ctf-special-training/assets/chunk_00181_00240_page_00009_img_in_image_box_193_163_1067_1412.webp){ width="100%" }

<div style="text-align: center;">图7-6 数据库查询语句未加锁导致的条件竞争</div>
