...
![图片](/books/ctf-special-training/assets/chunk_00601_00660_page_00010_img_in_image_box_163_814_1056_948.webp){ width="100%" }


<div style="text-align: center;">图15-1 大端小端存储示意图</div>
...
![图片](/books/ctf-special-training/assets/chunk_00601_00660_page_00011_img_in_image_box_282_978_970_1231.webp){ width="100%" }


<div style="text-align: center;">图15-2 宽度溢出示意图</div>
...
![图片](/books/ctf-special-training/assets/chunk_00601_00660_page_00013_img_in_image_box_241_177_975_473.webp){ width="100%" }


<div style="text-align: center;">图15-3 数据存储示意图</div>


在IDA中，查询part_1~part_4的内存地址，如图15-4所示。

![图片](/books/ctf-special-training/assets/chunk_00601_00660_page_00013_img_in_image_box_234_691_856_1148.webp){ width="100%" }


<div style="text-align: center;">图15-4 内存地址</div>


将上述代码编译出的程序放入gdb中进行调试，在相加完以后下断点，内存情况如图15-5所示。

![图片](/books/ctf-special-training/assets/chunk_00601_00660_page_00014_img_in_image_box_159_144_1074_577.webp){ width="100%" }


<div style="text-align: center;">图15-5 内存实际数据</div>


程序实际执行结果如图15-6所示。

![图片](/books/ctf-special-training/assets/chunk_00601_00660_page_00014_img_in_image_box_357_806_874_990.webp){ width="100%" }


<div style="text-align: center;">图15-6 执行结果</div>
...
![图片](/books/ctf-special-training/assets/chunk_00601_00660_page_00016_img_in_image_box_180_182_1028_928.webp){ width="100%" }


<div style="text-align: center;">图15-7 符号转换示意图</div>
...
![图片](/books/ctf-special-training/assets/chunk_00601_00660_page_00019_img_in_image_box_172_757_1037_1037.webp){ width="100%" }


<div style="text-align: center;">图15-8 数据访问示意图</div>
...
![图片](/books/ctf-special-training/assets/chunk_00601_00660_page_00021_img_in_image_box_491_272_733_424.webp){ width="100%" }


<div style="text-align: center;">图15-9 运行结果</div>


用gdb进行调试，在打印时下断点，查看内存情况，如图15-10所示。

![图片](/books/ctf-special-training/assets/chunk_00601_00660_page_00022_img_in_image_box_167_167_1062_871.webp){ width="100%" }


<div style="text-align: center;">图15-10 内存数据</div>
...
<div style="text-align: center;">图15-11 note3程序edit功能的反编译代码</div>
...
<div style="text-align: center;">图15-12 整型数据溢出关键点</div>
...
<div style="text-align: center;">图15-13 全局数组布局情况</div>
