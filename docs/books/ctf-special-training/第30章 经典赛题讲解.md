...
```
<div style="text-align: center;">图30-1 整理后的main函数</div>

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00002_img_in_image_box_192_141_1032_469.webp){ width="100%" }


<div style="text-align: center;">图30-2 内存数据</div>
...
```
<div style="text-align: center;">图30-3 进一步识别关键函数</div>


![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00003_img_in_image_box_283_845_943_1068.webp){ width="100%" }


<div style="text-align: center;">图30-4 对固件进行patch</div>


同时还要修改R0，原来是0x2000000C+0x10，现在0x2000000C变成了0x2000026C，那么要相应减去0x00000250，最后的patch结果如图30-5所示。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00004_img_in_image_box_219_136_989_293.webp){ width="100%" }


<div style="text-align: center;">图30-5 修改后的固件</div>


由于IDA不支持保存到hex文件，因此我们直接将hex文件用文本编辑器打开，按图30-6所示的字节修改即可。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00004_img_in_image_box_295_542_927_938.webp){ width="100%" }


<div style="text-align: center;">图30-6 用文本编辑器修改Intel hex文件</div>


注意，行末的checksum原来为76，修改为如图30-6所示的结果后要改为E7，否则加载时会报checksum错误提示。关于Intel hex格式的checksum计算，大家可以参考图30-7。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00005_img_in_image_box_154_137_1079_542.webp){ width="100%" }


<div style="text-align: center;">图30-7 Intel hex格式</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00005_img_in_image_box_192_987_1033_1318.webp){ width="100%" }


<div style="text-align: center;">图30-8 UART窗口获得答案</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00007_img_in_image_box_336_191_883_1217.webp){ width="100%" }


<div style="text-align: center;">图30-9 TWI函数片段</div>

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00008_img_in_image_box_232_137_992_740.webp){ width="100%" }


<div style="text-align: center;">图30-10 下断点位置</div>

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00009_img_in_image_box_154_150_936_842.webp){ width="100%" }


<div style="text-align: center;">图30-11 AVR Studio中对应的断点位置</div>


第1个陷阱：sub_A5实际上是一个TWI通信函数，在本题中与题目无关，但在实际运行的时候会导致程序卡住，所以直接patch掉这句！nop的机器码是0000，Patch完后用AVR Studio重新加载程序，如图30-12所示。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00010_img_in_image_box_243_137_983_810.webp){ width="100%" }


<div style="text-align: center;">图30-12 nop程序的位置</div>


第2个陷阱：此处有一个很长的二重循环，像是一个软件延时，且对调试并没有什么用，也需要全部nop掉，如图30-13所示。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00011_img_in_image_box_161_133_1080_617.webp){ width="100%" }


<div style="text-align: center;">图30-13 第二处Patch位置</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00012_img_in_image_box_153_135_1078_820.webp){ width="100%" }


<div style="text-align: center;">图30-14 第三处patch位置</div>

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00013_img_in_image_box_153_133_887_866.webp){ width="100%" }


<div style="text-align: center;">图30-15 需要分析的断点位置</div>

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00014_img_in_image_box_150_137_1085_658.webp){ width="100%" }


<div style="text-align: center;">图30-16 AVR Studio的内存浏览器</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00015_img_in_image_box_457_138_797_1327.webp){ width="100%" }


<div style="text-align: center;">图30-17 关键逻辑位置</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00018_img_in_image_box_155_636_1079_1414.webp){ width="100%" }

<div style="text-align: center;">图30-18 binwalk分析结果</div>
...
<div style="text-align: center;">图30-19 Wikipedia上的Vxworks介绍</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00020_img_in_image_box_183_699_1042_1366.webp){ width="100%" }

<div style="text-align: center;">图30-20 固件加载窗口</div>


在不知道基地址的时候，我们先按0地址加载，加载上去看看能不能分析出代码，如图30-21所示。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00021_img_in_image_box_310_376_913_1092.webp){ width="100%" }


<div style="text-align: center;">图30-21 memory organization 窗口</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00022_img_in_image_box_242_232_958_560.webp){ width="100%" }


<div style="text-align: center;">图30-22 CPU具体类型选择窗口</div>


加载后发现已经能分析出部分代码了，但没有符号，甚至还有解析问题，如图30-23所示。下一步，我们就需要确定基地址，以解决这些问题。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00023_img_in_image_box_153_145_1078_1088.webp){ width="100%" }


<div style="text-align: center;">图30-23 固件加载完成之后的界面</div>


在28.3节中我们介绍过PPC的基地址确定方法，下面找一条@ha的直接寻址指令，如图30-24所示。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00024_img_in_image_box_159_160_1071_335.webp){ width="100%" }


<div style="text-align: center;">图30-24 相对寻址指令处</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00025_img_in_image_box_299_141_926_869.webp){ width="100%" }


<div style="text-align: center;">图30-25 重新加载固件窗口</div>

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00026_img_in_image_box_398_144_829_815.webp){ width="100%" }


<div style="text-align: center;">图30-26 重新加载后的函数列表</div>


最后一步，重建符号表，先在程序中找到符号表，如图30-27所示。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00027_img_in_image_box_150_137_920_743.webp){ width="100%" }


<div style="text-align: center;">图30-27 程序的符号表的所在位置</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00028_img_in_image_box_153_139_1084_1047.webp){ width="100%" }


<div style="text-align: center;">图30-28 恢复符号后的效果</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00029_img_in_image_box_167_151_1032_674.webp){ width="100%" }


<div style="text-align: center;">图30-29 网络上查询到的信息</div>
...
```
<div style="text-align: center;">图30-30 加密算法代码</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00031_img_in_image_box_148_139_1005_433.webp){ width="100%" }


<div style="text-align: center;">图30-31 加密算法被出题者修改的位置</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00032_img_in_chart_box_154_453_1081_1233.webp){ width="100%" }


<div style="text-align: center;">图30-32 题目文件的时序波形</div>


思路很明确，取绝对值后，结果如图30-33所示。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00033_img_in_image_box_152_250_1074_860.webp){ width="100%" }


<div style="text-align: center;">图30-33 题目波形取绝对值后的效果</div>


然后设计滤波器，这里使用29.3节提到的sptool进行设计和滤波，结果如图30-34所示。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00034_img_in_image_box_153_144_1078_917.webp){ width="100%" }


<div style="text-align: center;">图30-34 滤波器设计结果</div>


滤波后的结果如图30-35所示。

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00035_img_in_chart_box_176_170_1055_1223.webp){ width="100%" }


<div style="text-align: center;">图30-35 滤波器应用后的效果</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00037_img_in_image_box_162_475_1017_924.webp){ width="100%" }


<div style="text-align: center;">图30-36 传感器1题目文本</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00039_img_in_image_box_230_474_965_999.webp){ width="100%" }


<div style="text-align: center;">图30-37 传感器2题目文本</div>
...
```
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00042_img_in_image_box_244_144_977_659.webp){ width="100%" }


<div style="text-align: center;">图30-38 计算器运行效果</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00043_img_in_image_box_152_136_1080_1340.webp){ width="100%" }


<div style="text-align: center;">图30-39 程序存在栈溢出漏洞</div>
...
```
<div style="text-align: center;">图30-40 题目程序反编译后的代码</div>

![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00045_img_in_image_box_150_139_1079_905.webp){ width="100%" }


<div style="text-align: center;">图30-41 漏洞触发比较位置</div>
...
![图片](/books/ctf-special-training/assets/chunk_01141_01189_page_00047_img_in_image_box_153_140_1079_779.webp){ width="100%" }


<div style="text-align: center;">图30-42 题目获取shell后的效果图</div>
